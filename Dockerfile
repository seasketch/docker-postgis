...
LABEL maintainer="Chad Burt <chad@underbluewaters.net>"
...
RUN apt-get -y update; apt-get -y install build-essential autoconf  libxml2-dev zlib1g-dev netcat gdal-bin unzip
